...
<%
	List<Book> bookList = (List<Book>) request.getAttribute("nyukaList");
...
<body>
	...
	<form method="post" action="/zaiko2020/MultiServlet">
			...
			<li>
				...
				<table border=1>
					...
					<tr>
						...
						<% nyukaVal = maxVal - g.getStock(); %>
						<td id="nyuka"><input type="number" name="nyuka" value="0" min="0" max="<%= nyukaVal %>"></td>
							<% } %>
					</tr>
					<% } %>
				</table>
		...
		<button type="submit" name="access" value="nyukaRun">Confirm</button>
	</form>
	</div>
